...
public class KMILTCommonController {
	...
	@RequestMapping(value = "/adjustYearWork.htm")
	public ModelAndView adjustYearWork() {
		logger.info(" # adjustYearWork.htm 0 ");
		
		BuckWaRequest request = new BuckWaRequest();
		academicKPIService.adjustYearWork(request);
	...
	public ModelAndView download(@RequestParam("fileCode") String fileCode ,HttpServletRequest httpRequest, HttpServletResponse httpResponse,@RequestHeader("User-Agent") String userAgent) {
		...
		try {
			...
			if("manual1".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธนเน�เธกเธทเธญเธญเธ�เธฃเธกเน�เธ�เธฃเน�เธ�เธฃเธกเธฃเธฐเธ�เธ�เธ�เธฃเธฐเน€เธกเธดเธ�เธ�เธธเธ“เธ เธฒเธ�เธงเธดเธ�เธฒเธ�เธ�เธฒเธฃ.pdf";
				fullPath =  filePath+fileName;
			}else if("manual2".equalsIgnoreCase(fileCode)){
				fileName ="ADMIN เธ�เธ“เธฐ.pdf";
				fullPath =  filePath+fileName;
			}else if("manual3".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธนเน�เธกเธทเธญเธญเธ�เธฃเธกเน�เธ�เธฃเน�เธ�เธฃเธกเธฃเธฐเธ�เธ�เธ�เธฃเธฐเน€เธกเธดเธ�เธ�เธธเธ“เธ เธฒเธ�เธงเธดเธ�เธฒเธ�เธฒเธฃเธชเธณเธซเธฃเธฑเธ�เธ�เธฃเธฐเธ�เธฒเธ�เธชเธฒเธ�เธฒ.pdf";
				fullPath =  filePath+fileName;
			}else if("manual4".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธนเน�เธกเธทเธญเธญเธ�เธฃเธกเน�เธ�เธฃเน�เธ�เธฃเธกเธฃเธฐเธ�เธ�เธ�เธฃเธฐเน€เธกเธดเธ�เธ�เธธเธ“เธ เธฒเธ�เธงเธดเธ�เธฒเธ�เธฒเธฃเธชเธณเธซเธฃเธฑเธ�เธ�เธนเน�เธ�เธฃเธดเธซเธฒเธฃ.pdf";
				fullPath =  filePath+fileName;		 
			...
			if("declare01".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเธงเธดเธจเธงเธ�เธฃเธฃเธกเธจเธฒเธชเธ•เธฃเน�.pdf";
				fullPath =  filePath+fileName;
			}
			if("declare02".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเธชเธ–เธฒเธ�เธฑเธ•เธขเน�เธ�เธฃเธฃเธกเธจเธฒเธชเธ•เธฃเน�.pdf";
				fullPath =  filePath+fileName;
			}			
			
			if("declare03".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเธ�เธฃเธธเธจเธฒเธชเธ•เธฃเน�เธญเธธเธ•เธชเธฒเธซเธ�เธฃเธฃเธก.pdf";
				fullPath =  filePath+fileName;
			}				
			
			
			if("declare04".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเน€เธ—เธ�เน�เธ�เน�เธฅเธขเธตเธ�เธฒเธฃเน€เธ�เธฉเธ•เธฃ.pdf";
				fullPath =  filePath+fileName;
			}			
			
			if("declare05".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเธงเธดเธ—เธขเธฒเธจเธฒเธชเธ•เธฃเน�.pdf";
				fullPath =  filePath+fileName;
			}		
			
			if("declare06".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเธญเธธเธ•เธชเธฒเธซเธ�เธฃเธฃเธกเน€เธ�เธฉเธ•เธฃ.pdf";
				fullPath =  filePath+fileName;
			}		
			
			if("declare07".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเน€เธ—เธ�เน�เธ�เน�เธฅเธขเธตเธชเธฒเธฃเธชเธ�เน€เธ—เธจ.pdf";
				fullPath =  filePath+fileName;
			}		
			if("declare09".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธงเธดเธ—เธขเธฒเธฅเธฑเธขเธ�เธฒเธ�เธฒเธ�เธฒเธ•เธด.pdf";
				fullPath =  filePath+fileName;
			}					
			
			if("declare10".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธงเธดเธ—เธขเธฒเธฅเธฑเธขเธ�เธฒเน�เธ�เน€เธ—เธ�เน�เธ�เน�เธฅเธขเธตเธ�เธฃเธฐเธ�เธญเธกเน€เธ�เธฅเน�เธฒเธฅเธฒเธ”เธ�เธฃเธฐเธ�เธฑเธ�.pdf";
				fullPath =  filePath+fileName;
			}					
			
			if("declare11".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธงเธดเธ—เธขเธฒเธฅเธฑเธขเธ�เธงเธฑเธ•เธ�เธฃเธฃเธกเธ�เธฒเธฃเธ�เธฅเธดเธ•เธ�เธฑเน�เธ�เธชเธนเธ�.pdf";
				fullPath =  filePath+fileName;
			}					
			if("declare12".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธ�เธ“เธฐเธ�เธฒเธฃเธ�เธฃเธดเธซเธฒเธฃเน�เธฅเธฐเธ�เธฑเธ”เธ�เธฒเธฃ.pdf";
				fullPath =  filePath+fileName;
			}		
			
			if("declare13".equalsIgnoreCase(fileCode)){
				fileName ="เธ�เธฃเธฐเธ�เธฒเธจ 2558 เธงเธดเธ—เธขเธฒเน€เธ�เธ•เธ�เธธเธกเธ�เธฃเน€เธ�เธ•เธฃเธญเธธเธ”เธกเธจเธฑเธ�เธ”เธดเน�.pdf";
				fullPath =  filePath+fileName;
			}		
