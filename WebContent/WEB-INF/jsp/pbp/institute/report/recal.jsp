 	...
 	<br>
 	 <table style="width: 400px;" >
 	 	<tr> 
 	 		...
 	 		<td width="200px;">
 	 		 <a rel="notLoading" href="<%=request.getContextPath()%>/pbp/institute/report/recal.htm?academicYear=<c:out value="${academicYearStr}"/>">  
					 <input class="btn btn-primary" value="Recal" type="button"   /> 
			 </a> 
 	 		</td>
